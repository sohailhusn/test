...
const require$1 = node_module.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (document.currentScript && document.currentScript.src || new URL('shared/ni.42d614bb.cjs', document.baseURI).href)));
...
const fs_1$1 = require$$0__default$2;
