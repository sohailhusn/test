...
function init(open, close) {
	...
	return function (txt) {
		if (this !== void 0 && this.has !== void 0) {
			...
			return txt === void 0 ? this : $$1.enabled ? run$1(this.keys, txt+'') : txt+'';
		}
		return txt === void 0 ? chain([open], [blk]) : $$1.enabled ? run$1([blk], txt+'') : txt+'';
	};
}
...
const delimiter$1 = completing =>
  c$1.gray(completing ? figures$7.ellipsis : figures$7.pointerSmall);

const item = (expandable, expanded) =>
  c$1.gray(expandable ? (expanded ? figures$7.pointerSmall : '+') : figures$7.line);
...
async function openTemp() {
  ...
  const competitivePath = join$1(CLI_TEMP_DIR, `.${process$1.pid}.${counter}`);
  counter += 1;
...
export { AGENTS as A, CLI_TEMP_DIR as C, INSTALL_PAGE as I, LOCKS as L, UnsupportedCommand as U, parseNi as a, parseNlx as b, parseNu as c, prompts$1 as d, exclude as e, parseNun as f, formatPackageWithUrl as g, c as h, parseNr as i, getConfig as j, getDefaultAgent as k, limitText as l, getGlobalAgent as m, detect as n, getCommand as o, parseNa as p, getCliCommand as q, runCli as r, serializeCommand as s, run as t, remove as u, cmdExists as v, writeFileSafe as w, COMMANDS as x, constructCommand as y, resolveCommand as z };
